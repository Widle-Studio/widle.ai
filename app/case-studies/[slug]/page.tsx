...
const caseStudies = {
  ...
  "future-generative-ai": {
    ...
    industry: "Trends",
    image: "/images/Widle-Logo.jpg",
    challenge: "Generative models are moving from novelties to core business tools. How can enterprises prepare for this shift?",
    solution: "We explore the key technological and strategic shifts necessary to harness the power of generative AI securely and effectively.",
    results: "Discover actionable frameworks for deploying generative models across organizational workflows.",
    metrics: [
      { value: "40%", label: "Productivity Boost", description: "Potential gains in knowledge work" },
      { value: "70%", label: "Task Automation", description: "Routine communication tasks" },
      { value: "2x", label: "Innovation Speed", description: "Faster ideation to prototype" },
    ],
    content: {
      sections: [
        {
          type: "heading",
          text: "From Novelty to Core Business Tool",
        },
        {
          type: "paragraph",
          text: "Generative AI is no longer just a fascinating technology demo; it is rapidly becoming an essential utility for modern enterprises. From automating routine drafting and summarization to accelerating complex software development, the impact is pervasive.",
        },
        {
          type: "paragraph",
          text: "However, moving from playground environments to production requires addressing significant challenges around data privacy, hallucination mitigation, and cost management.",
        }
      ],
    },
    relatedCaseStudies: ["medtech-ai-diagnostics", "trust-in-ai"],
  },
  "trust-in-ai": {
    ...
    industry: "Ethics",
    image: "/images/Widle-Logo.jpg",
    challenge: "As AI systems make more critical decisions, the lack of transparency and explainability creates significant risk and slows adoption.",
    solution: "Implementing robust MLOps practices, explainable AI (XAI) frameworks, and human-in-the-loop oversight mechanisms.",
    results: "A comprehensive approach to ensuring AI systems remain aligned, unbiased, and transparent to end-users.",
    metrics: [
      { value: "100%", label: "Auditability", description: "Traceable decision pathways" },
      { value: "0", label: "Black Box", description: "Focus on explainable models" },
      { value: "99%", label: "Compliance", description: "Adherence to AI regulations" },
    ],
    content: {
      sections: [
        {
          type: "heading",
          text: "The Explainability Imperative",
        },
        {
          type: "paragraph",
          text: "Trust is the ultimate currency for AI adoption in the enterprise. If business leaders and end-users cannot understand why a model makes a specific recommendation, they will refuse to use it for high-stakes decisions.",
        },
        {
          type: "paragraph",
          text: "Building trust requires a multi-layered approach: technically robust explainability techniques, rigorous bias testing during development, and clear communication interfaces for the end-user.",
        }
      ],
    },
    relatedCaseStudies: ["fintech-fraud-detection", "future-generative-ai"],
  },
  "mlops-guide": {
    ...
    image: "/images/Widle-Logo.jpg",
    challenge: "Many organizations struggle to move machine learning models from Jupyter notebooks into reliable, scalable production environments.",
    solution: "A deep dive into the best practices for continuous integration, deployment, and monitoring of ML models.",
    results: "Learn how to build resilient pipelines that automatically detect model drift and trigger retraining.",
    metrics: [
      { value: "10x", label: "Deployment Speed", description: "Faster model rollouts" },
      { value: "24/7", label: "Monitoring", description: "Automated drift detection" },
      { value: "99.9%", label: "Uptime", description: "Reliable production serving" },
    ],
    content: {
      sections: [
        {
        ...
        {
          type: "paragraph",
          text: "Machine Learning Operations (MLOps) is the bridge between data science experimentation and software engineering reliability. It applies DevOps principles to the unique challenges of machine learning.",
        },
        {
          type: "paragraph",
          text: "A successful MLOps practice ensures that models can be reliably deployed, continuously monitored for statistical drift, and seamlessly updated without downtime.",
        }
      ],
    },
    relatedCaseStudies: ["retail-demand-forecasting", "future-generative-ai"],
  }
}
